<template>
  <div v-if= "direction === 'h'" class="wx-scroll-h">
    <div class="wx-scroll-h-nav" ref="nav">
      <div class="wx-scroll-h-container" ref="box" @touchstart="touchstart" @mousedown="touchstart">
        <slot></slot>
      </div>
    </div>
  </div>
  <div v-else class="wx-scroll-v">
    <div class="wx-scroll-v-nav" ref="nav">
      <div class="wx-scroll-v-container" ref="box" @touchstart="touchstart" @mousedown="touchstart">
        <slot></slot>
      </div>
    </div>
  </div>
      ...
      if (this.drag) {
        ...
        if (this.direction == 'h') {
          ...
          let lastx = this.currentX + offsetX
                    ...
                    if( Math.round(offsetY)>10){
                      console.log("offsetYoffsetYoffsetY");
