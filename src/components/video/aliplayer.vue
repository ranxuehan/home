...
export default {
  ...
  props: {
    ...
    aliplayerSdkPath: {
      // Aliplayer 代码的路径
      type: String,
      default: '//g.alicdn.com/de/prismplayer/2.7.2/aliplayer-min.js'
    },
      status:{
          type: Boolean,
          default: false
  ...
  data() {
    return {
      playerId: _.replace('aliplayer_' + Math.random() * 100000000000000000,".","4"),
      scriptTagStatus: 0,
      instance: null
    }
  },
      ...
      if (_this.scriptTagStatus === 2 && _this.instance === null) {
        ...
        _this.$nextTick(() => {
          _this.instance = window.Aliplayer({
            ...
            source: _this.source,
            cover: "http://img.alicdn.com/tps/TB1EXIhOFXXXXcIaXXXXXXXXXXX-760-340.jpg",
